...
enum backoffTypes
{
	BACKOFF_SLEEP_INT = 114,
	BACKOFF_CONSTANT = 115,
	BACKOFF_MULTIPLYING = 116,
	BACKOFF_EXPONENTIAL = 117
};
...
class TunableMacModule : public cSimpleModule 
{
	...
	// parameters and variables
		...
		cMessage *dutyCycleSleepMsg;	
		cMessage *dutyCycleWakeupMsg;
	...
	protected:
		...
		int encapsulateAppPacket(App_GenericDataPacket *appPacket, MAC_GenericFrame *retFrame);
