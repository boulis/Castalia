...
{
	NO_COLLISIONS = 120,
	SIMPLE_COLLISION_MODEL = 121,
	ADDITIVE_INTERFERENCE_MODEL = 122,
	COMPLEX_INTERFERENCE_MODEL = 123
};
...
class WirelessChannel : public cSimpleModule {
	private:
		...
		const char * rxSignal_ConnectivityMap;
		const char * PRR_ConnectivityMap;
		int defaultPowerLevel;
		double minumumPacketSize;					//in bytes
